...
const searchNASAImages = async () => {
    ...
    try {
        ...
        contenedor.innerHTML = '';  // Limpiar contenedor de resultados anteriores

        // Crear la fila para las tarjetas
        const row = document.createElement('div');
        row.className = 'row';  // Clase para las tarjetas en fila
        ...
        items.forEach((item) => {
            ...
            card.className = 'col-12 col-md-4 mb-4';  // Asegura 1 columna en móvil y 3 en escritorio (col-12 y col-md-4)
            card.style.width = '100%';  // El ancho lo gestiona el grid de Bootstrap
            ...
            // Asegúrate de que el botón "Ver más" se oculte si no hay descripción o si es muy corta
